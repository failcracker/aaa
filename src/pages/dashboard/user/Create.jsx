...
export default function Create({ open, onClose, refreshData }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      refreshData()
      onClose()
      setFormData({ name: '', email: '', password: '', role: '', department: '', phone_number: '', address: '', npwp: '' })
    } catch (error) {
      console.error('Error submitting form:', error)

      toast.error(error.response.data.message || 'User gagal dibuat, coba lagi nanti')
    }
    setLoading(false)
  }
